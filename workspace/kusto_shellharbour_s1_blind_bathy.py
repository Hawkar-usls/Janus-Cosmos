...
SRC=json.loads((ROOT/"data/cousteau/JANUS-KUSTO-SHELLHARBOUR-S0C-EXACT-MEMBER-BINDING-RECEIPT-2026-09-23-v1.0.json").read_text())
...
def load_bathy():
    ...
    heldout=SRC["heldout_member_also_present_in_transport_archive"]["name"]
    with zipfile.ZipFile(io.BytesIO(blob)) as zf:
        ...
        # Scientific firewall: only the frozen 2 m bathymetry member is decompressed.
        # The held-out 5 m backscatter member is never opened/read/hashed in S1.
        tif=zf.read(member)
...
out={
 ...
 "input":input_meta,
 "truth_firewall":{"transport_archive_contains_backscatter_member":True,"backscatter_member_decompressed":False,"backscatter_values_read":False,"landform_or_sediment_labels_read":False},
 ...
 "claim_ceiling":"UNSEEN_AUSTRALIAN_MARINE_BLIND_BATHYMETRIC_ANOMALY_CANDIDATE_GENERATION_ONLY"
}
p=OUT/"JANUS-KUSTO-SHELLHARBOUR-S1-BLIND-BATHYMETRY-RUN-2026-09-23-v1.0.json"

...
UA={"User-Agent":"JANUS-KUSTO-INFOMAR-I1I-CB13_05/1.0","Accept-Encoding":"identity"}
...
with tempfile.TemporaryDirectory(prefix="kusto_i1i_cb1305_") as td0:
    ...
    for q in all_flags:
        ...
        q=dict(q); q["candidate_id"]=f"INFOMAR_CB13_05_C{len(kept)+1:03d}"; q["blind_rank"]=len(kept)+1
        kept.append(q)
        if len(kept)>=MAX_CAND: break

    out={
      "artifact_id":"JANUS-KUSTO-INFOMAR-I1I-CB13_05-BLIND-BATHYMETRY-RUN-2026-09-25-v1.0",
      "freeze":FREEZE["artifact_id"],"SURVEY_ID":SID,"rank":3,
      ...
      "next_gate":"I1J_CB13_05_FROZEN_CANDIDATE_BACKSCATTER_REPLAY_V2",
      "claim_ceiling":"INFOMAR_CB13_05_BLIND_BATHYMETRIC_CANDIDATE_GENERATION_ONLY"
    }
    raw=json.dumps(out,indent=2); p=OUT/"JANUS-KUSTO-INFOMAR-I1I-CB13_05-BLIND-BATHYMETRY-RUN-2026-09-25-v1.0.json"; p.write_text(raw)

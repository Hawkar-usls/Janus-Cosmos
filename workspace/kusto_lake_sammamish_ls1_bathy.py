...
UA={"User-Agent":"JANUS-KUSTO-LakeSammamish-LS1-blind-bathy/1.0"}
CELL=2.0
RADII=[8,16,32,64]
STRIDE=16.0
TAIL=.995
...
for q in all_flags:
    ...
    q=dict(q);q["candidate_id"]=f"SAM_BATHY_C{len(kept)+1:03d}";q["blind_rank"]=len(kept)+1
    kept.append(q)
    if len(kept)>=MAX_CAND:break

out={
 "artifact_id":"JANUS-KUSTO-LAKE-SAMMAMISH-LS1-BLIND-BATHYMETRY-RUN-2026-09-23-v1.0",
 ...
 "next_gate":"LS2_FROZEN_CANDIDATE_BACKSCATTER_REPLAY",

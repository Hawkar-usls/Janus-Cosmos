...
UA={"User-Agent":"JANUS-KUSTO-MAR4DEG02S-temporal-calibration/1.0"}
...
out={
 "artifact_id":"JANUS-KUSTO-MAR4DEG02S-2005-TO-2008-STRICT-TEMPORAL-CALIBRATION-RUN-2026-09-22-v1.0",
 "prereg":"data/cousteau/JANUS-KUSTO-MAR4DEG02S-2005-TO-2008-TEMPORAL-CALIBRATION-PREREG-2026-09-22-v1.0.json",
 "target":C,
 ...
 "manifest":manifest,
 "claim_ceiling":"TEMPORAL_PIPELINE_CALIBRATION_ON_EXTERNAL_KNOWN_NATURAL_REGION"
}
p=OUT/"JANUS-KUSTO-MAR4DEG02S-2005-TO-2008-STRICT-TEMPORAL-CALIBRATION-RUN-2026-09-22-v1.0.json";p.write_text(json.dumps(out,indent=2))
...
sout={
 "artifact_id":"JANUS-KUSTO-MAR4DEG02S-2005-TO-2008-SUPPORT-MATCHED-CALIBRATION-RUN-2026-09-22-v1.0",
 "prereg":"data/cousteau/JANUS-KUSTO-MAR4DEG02S-2005-TO-2008-TEMPORAL-CALIBRATION-PREREG-2026-09-22-v1.0.json",
 "target":C,
 ...
 "parent_known_positive_2008_pass_preserved":True,
 "claim_ceiling":"TEMPORAL_PIPELINE_CALIBRATION_SUPPORT_MATCHED_SECONDARY__KNOWN_POSITIVE_REGION"
}
sp=OUT/"JANUS-KUSTO-MAR4DEG02S-2005-TO-2008-SUPPORT-MATCHED-CALIBRATION-RUN-2026-09-22-v1.0.json"
sp.write_text(json.dumps(sout,indent=2))
print("\nKNOWN_POSITIVE_SUPPORT_MATCHED_TEMPORAL_CALIBRATION")
print(json.dumps({

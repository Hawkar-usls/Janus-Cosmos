...
lout={
 "artifact_id":"JANUS-KUSTO-CAND003-CD169-EM12-LINE-ATTRIBUTION-RUN-2026-09-22-v1.0",
 "prereg":"data/cousteau/JANUS-KUSTO-CAND003-CD169-EM12-LINE-ATTRIBUTION-PREREG-2026-09-22-v1.0.json",
 "target":C,
 ...
 "strict_temporal_parent_fail_immutable":True,
 "claim_ceiling":"GEOMETRY_INFERRED_LINE_LEVEL_PROCESSED_PRODUCT_DIAGNOSTIC_ONLY"
}
lp=OUT/"JANUS-KUSTO-CAND003-CD169-EM12-LINE-ATTRIBUTION-RUN-2026-09-22-v1.0.json"
lp.write_text(json.dumps(lout,indent=2))
print("\nLINE_ATTRIBUTION_DIAGNOSTIC")
print(json.dumps({
 "nav":lout["nav"],
 "line_diagnostics":line_diag,
 "lines_passing_both_2008_lineages":pass_lines

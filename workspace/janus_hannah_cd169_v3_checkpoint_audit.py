...
def main():
    ...
    ck('all_raw_15_supported',d['v3_gates']['G3D_OUTLIER_DIAGNOSTICS']['full_raw_support']['anchors']==15 and d['v3_gates']['G3D_OUTLIER_DIAGNOSTICS']['full_raw_support']['anchors_with_good_raw_support']==15)
    ...
    va=d['v2_full_raw_support_corrected_audit'];ck('v2_full_raw_support_corrected_dominance',va['relative_dominance_pass'] and va['v2_full_raw_median_m']<va['v1_comparator_median_m'] and va['v2_full_raw_p90_m']<va['v1_comparator_p90_m'],{'v1_median':va['v1_comparator_median_m'],'v2_median':va['v2_full_raw_median_m'],'v1_p90':va['v1_comparator_p90_m'],'v2_p90':va['v2_full_raw_p90_m']})
    ck('unchanged_raw_model',va['model_parameters_changed'] is False and va['support_source'].startswith('actual raw TOBI.DAT'))
    ck('processed_header_check_demoted',d['processed_cdf_header_sensitivity_check']['role']=='SECONDARY_SENSITIVITY_ONLY_NOT_CANONICAL_RAW_V2')

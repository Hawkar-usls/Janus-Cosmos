...
IMP=json.loads((ROOT/"data/cousteau/JANUS-KUSTO-INFOMAR-I1J-CB13_05-UNCHANGED-V2-IMPLEMENTATION-FREEZE-2026-09-25-v1.0.json").read_text())
BR=json.loads((ROOT/"data/cousteau/JANUS-KUSTO-INFOMAR-I1J-CB13_05-WGS84-BACKSCATTER-NATIVE-METRIC-BRIDGE-2026-09-25-v1.0.json").read_text())
FR={"selected":{}}
...
AUTH=json.loads((ROOT/"data/cousteau/JANUS-KUSTO-INFOMAR-I1I-CB13_05-BLIND-BATHYMETRY-RECEIPT-2026-09-25-v1.0.json").read_text())

UA={"User-Agent":"JANUS-KUSTO-INFOMAR-I1J-CB13_05-v2/1.0","Accept-Encoding":"identity"}
...
with tempfile.TemporaryDirectory(prefix="kusto_infomar_i1j_cb1305_") as td:
    tmp=Path(td)
    ...
    status=("PASS_PREREGISTERED_UNSEEN_INFOMAR_CB13_05_PAIRED_SUPPORT_DOMAIN_V2_VALIDATION"
            if primary_pass else
            "PRIMARY_VALIDATION_BLOCKED_BY_SUPPORT_COVERAGE_OR_DEGENERATE_STRATUM"
            if blocked else
            "NO_PREREGISTERED_UNSEEN_INFOMAR_CB13_05_PAIRED_SUPPORT_DOMAIN_V2_VALIDATION")

    out={
      "artifact_id":"JANUS-KUSTO-INFOMAR-I1J-CB13_05-UNSEEN-BACKSCATTER-V2-RUN-2026-09-25-v1.0",
      ...
      "claim_ceiling":"PREREGISTERED_UNSEEN_INFOMAR_CB13_05_SAME_SURVEY_CROSSCHANNEL_V2_VALIDATION"
    }
    p=OUT/"JANUS-KUSTO-INFOMAR-I1J-CB13_05-UNSEEN-BACKSCATTER-V2-RUN-2026-09-25-v1.0.json"

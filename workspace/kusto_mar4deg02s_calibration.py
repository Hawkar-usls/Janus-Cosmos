...
PREREG="data/cousteau/JANUS-KUSTO-MAR-4DEG02S-KNOWN-POSITIVE-CALIBRATION-PREREG-2026-09-22-v1.0.json"
...
out={
 "artifact_id":"JANUS-KUSTO-MAR-4DEG02S-KNOWN-POSITIVE-2008-CROSS-SURVEY-CALIBRATION-2026-09-22-v1.0",
 "prereg":PREREG,
 "lineages":SURVEYS,
 "inventory":inventory,
 "results":results,
 "pass_candidates":[r["id"] for r in results if r.get("primary_reproduction_gate_pass")],
 "calibration_role":"EXTERNAL_KNOWN_POSITIVE_REGION__NOT_DISCOVERY",
 "claim_ceiling":"PIPELINE_CALIBRATION_ON_EXTERNAL_KNOWN_GEOLOGIC_REGION__NO_EXACT_VENT_IDENTITY__NO_ARTIFICIALITY"
}
p=OUT/"JANUS-KUSTO-MAR-4DEG02S-KNOWN-POSITIVE-2008-CROSS-SURVEY-CALIBRATION-2026-09-22-v1.0.json"

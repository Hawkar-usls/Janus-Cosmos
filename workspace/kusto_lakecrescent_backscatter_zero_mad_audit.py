...
out={
    ...
    "interpretation":(
        "POSTHOC_ROBUSTNESS_SUPPORT__NO_SCIENTIFIC_PROMOTION"
        if robustness_signal else
        "PARENT_SIGNAL_NOT_ROBUST_TO_ZERO_MAD_HANDLING"
    ),
    "claim_ceiling":"POSTHOC_ROBUSTNESS_DIAGNOSTIC_ONLY__NOT_PREREGISTERED_CONFIRMATION"
}

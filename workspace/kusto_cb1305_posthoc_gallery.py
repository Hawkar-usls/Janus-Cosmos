...
OUT=ROOT/"workspace"/"kusto_global_groundtruth_out"/"cb1305_gallery"; OUT.mkdir(parents=True,exist_ok=True)
TOKEN=os.environ["GITHUB_TOKEN"]; REPO=os.environ["GITHUB_REPOSITORY"]
ART=10837548996
FREEZE=json.loads((ROOT/"data/cousteau/JANUS-KUSTO-INFOMAR-I1J-CB13_05-UNCHANGED-V2-IMPLEMENTATION-FREEZE-2026-09-25-v1.0.json").read_text())
